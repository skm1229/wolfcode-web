                        ...
                        <select name="custId">
                            <#list custs as cust>
                                <#if cust.id=obj.custId>
                                    <option selected value="${cust.id}">${cust.customerName}
                                    </option>
                                <#else >
...
<#--                               class="layui-input">-->
                        <select name="linkmanId">
                            <#list linkmans as linkamn>
                                <#if linkamn.id=obj.linkmanId>
                                    <option selected value="${linkamn.id}">${linkamn.linkman}
                                    </option>
                                <#else >
                                    <option value="${linkamn.id}">${linkamn.linkman}</option>
                                </#if>
                            </#list>
                        </select>
                    </div>
...
<script type="text/javascript" src="${request.contextPath}/scripts/contacts/visit/update.js?_=${randomNum}"></script>
</body>
