    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <@sec.authenticate grants="cust:customer:list">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="List-toolbar">
                        <div class="layui-btn-container">
                            <@sec.authenticate grants="cust:customer:add">
...
<script type="text/javascript" src="${request.contextPath}/scripts/cust/customer/list.js?_=${randomNum}"></script>
</body>
</html>
